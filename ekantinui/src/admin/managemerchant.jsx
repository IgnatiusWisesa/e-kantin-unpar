...
class Managemerchant extends Component {
    state = { 
        ...
        loading: true,
        // state foto kantin
        kantinfotoawal: "https://cdn1.iconfinder.com/data/icons/school-education-9/24/school_canteen_lunch_canteen_food_fork_school_community_eating-512.png",
        insertfoto: -1,
        // modal tambah kantin
        modaladd: false,
     ...
     onClickSave=()=>{
         ...
         let kantinbaru = {
             foto, nama, lokasi, telepon, whatsapp, deskripsi
         }
     ...
     onClickEdit=()=>{
        ...
        let index =  this.state.indexedit
         ...
         let kantinedit = {
            nama, lokasi, whatsapp, deskripsi
         }
                    ...
                    <TableCell style={{width: '50px'}}>{val.id}</TableCell>
                    {
                        ...
                        <TableCell style={{width: '300px'}}>
                            <img 
                                ...
                                alt="Canteen's Photo" 
                                onClick={()=>{this.setState({ insertfoto: val.id })}}
                            />
                        </TableCell>
                    }
                    <TableCell>
                        <TableBody>
                            <TableRow>Nama <a style={{paddingLeft:'30px'}}>: {val.nama}</a></TableRow>
                            <TableRow>Lokasi <a style={{paddingLeft:'27px'}}>: {val.lokasi}</a></TableRow>
                            <TableRow>Whatsapp <a style={{paddingLeft:'6px'}}>: {val.whatsapp}</a></TableRow>
                            <TableRow>Deskripsi <a style={{paddingLeft:'12px'}}>: {val.deskripsi}</a></TableRow>
                        </TableBody>
                    </TableCell>
                    <TableCell>
                        <TableBody>
                            <TableRow>
                                <Box mb={1}>
                                    <Button onClick={()=>this.setState({ idedit:val.id, indexedit:index, modaledit: true })} variant="outlined" style={{width: '150px',color: purple.A200}}>
                                        Edit Profile
                                    </Button>
                                </Box>
                            </TableRow>
                            ...
                            <TableRow>
                                <Button onClick={()=>this.onClickDelete(val.id, index)} variant="outlined" style={{width: '150px'}} color="secondary">
                                    Delete
                                </Button>
                            </TableRow>
                        </TableBody>
                            ...
                            <TableRow>
                                ...
                                <TableCell>
                                    <Box mb={1} mt={1} style={{paddingLeft:'30vh'}}>
                                        <Button onClick={()=>{this.setState({ modaladd:true })}} variant="outlined" style={{width: '150px',color: lightGreen.A700}}>
                                            Tambah Kantin
                                        </Button>
                                    </Box>
                                </TableCell>
